...
class BudgetRecord:
    ...
    def composite_key(self) -> str:
        ...
        return f"{self._normalize(self.agency)}|{self.appropriation_id}|{self.chapter_year}|{self._normalize(self.account)}"
...
class ReportGenerator:
    ...
    def generate_all_reports(self, results: ComparisonResults) -> Dict[str, Path]:
        ...
        outputs['discontinued'] = self._write_discontinued_csv(results.discontinued)
    ...
    def _write_discontinued_csv(self, discontinued: List[ComparisonResult]) -> Path:
        """Write main discrepancy report."""
        path = self.output_dir / 'discontinued_reappropriations.csv'
